...
# Deleted --> input_data = st.text_input("Block Data")

# @TODO:
# Add an input area where you can get a value for `sender` from the user.
sender = st.text_input("Please enter Sender Information")

# @TODO:
# Add an input area where you can get a value for `receiver` from the user.
receiver = st.text_input("Please enter Receiver Information")

# @TODO:
# Add an input area where you can get a value for `amount` from the user.
amount = st.text_input("Please enter Transaction Amount")
